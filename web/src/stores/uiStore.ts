...
export type ModalName = 'imageInfo' | 'preferences' | 'shortcuts' | 'about' | 'samples' | 'saveProject' | 'exportRoiImages' | 'equations' | 'batch' | 'featureMap' | 'thresholdRoi' | 'growRoi' | 'roiClasses' | 'report' | 'profile' | 'histogram' | 'colourConversion';
