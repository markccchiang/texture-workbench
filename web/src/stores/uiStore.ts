...
export type ModalName = 'imageInfo' | 'preferences' | 'shortcuts' | 'about' | 'samples' | 'saveProject' | 'exportRoiImages' | 'equations' | 'batch' | 'featureMap' | 'thresholdRoi' | 'roiClasses' | 'report';
