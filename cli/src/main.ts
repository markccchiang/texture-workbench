...
function usage(io: Io): void {
  ...
  io.out(
    [
      ...
      '  --server <url>    a running server (or GLCM_SERVER); without it the API runs in this process',
      ...
      '',
      'Example:',
      '  glcm regions sample:medical/ct-chest.png --min 0 --max 700 --min-pixels 4000 --max-pixels 100000 --out lungs.roi.json',
